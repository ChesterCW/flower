...
<form action="${pageContext.request.contextPath}/modifyCommodity" method="post">
    <div class="container" style="width: 35%">
        <h2 style="padding-bottom: 5%"><strong>查看材料信息</strong></h2>
        <div class="form-group">
            <input type="hidden" name="id" value="${material.id}">
            <label>材料名称:</label>&nbsp;&nbsp;&nbsp;
            <label style="font-size: large">${material.name}</label>
        </div>
        <div class="form-group">
            <label>数量:</label>&nbsp;&nbsp;&nbsp;
            <label style="font-size: large">${material.count}</label>
        </div>
        <div class="form-group">
            <label>市场价格:</label>&nbsp;&nbsp;&nbsp;
            <label style="font-size: large">${material.marketprice}</label>
        </div>
        <div class="form-group">
            <label>会员价格:</label>&nbsp;&nbsp;&nbsp;
            <label style="font-size: large">${material.vipprice}</label>
        </div>
        <div class="form-group">
            <label>材料描述</label>
