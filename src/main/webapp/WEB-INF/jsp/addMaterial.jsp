...
<form action="${pageContext.request.contextPath}/addMaterial" method="post">
    <div class="container" style="width: 35%">
        ...
        <div class="form-group">
            <label>材料描述</label>
            <textarea rows="10" cols="79%" id="description" name="description"></textarea>
        </div>
        ...
        <div class="form-group">
            <div align="center">
                ...
                <button type="submit" name="submit" onclick="javascript:history.back(-1);" class="btn btn-primary">提交</button>
            </div>
        </div>
    </div>
</form>
