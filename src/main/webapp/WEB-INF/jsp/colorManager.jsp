...
<script>
    //添加页面
    function addItems() {
        location.href="${pageContext.request.contextPath}/addColor";
    }
        ...
        if($('#cusTable').bootstrapTable('getSelections').length<1){
            ...
            BootstrapDialog.show({
                ...
                buttons:[{label:'关闭',cssClass : "btn-primary", action : function(dialog){   //给当前按钮添加点击事件
                        ...
                        dialog.close();
                        $.post('deleteColor',{'ids':ids},function (data) {
                            alert("删除成功");
                            location.href = "colorManager";
                        })
                    }}
                ]
            });
    ...
    $(function () {
        ...
        $('#cusTable').bootstrapTable({
            ...
            sortable: true,
            silentSort:true,
            url: '${pageContext.request.contextPath}/colorList',
            striped: true,
