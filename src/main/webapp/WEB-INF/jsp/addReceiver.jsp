    ...
    <div class="modal-dialog" style="margin-top: 0px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="attNotice">添加收货人</h4>
            </div>
            <div class="modal-body">

                <form class="form-horizontal form-group-sm" id="receiverForm" onsubmit="return confirmForm()"
                      action="${pageContext.request.contextPath}/addReceiver" method="post">
                    <div class="form-group">
                        <label class="col-xs-2 control-label">收货人姓名:</label>
                        <div class="col-xs-2">
                            <input type="text" class="form-control" id="name" name="name" value="" maxlength="15" autofocus="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-2 control-label">收货人手机:</label>
                        <div class="col-xs-5">
                            <input type="text" class="form-control" id="phone" name="phone" value="" maxlength="25">
                        </div>
                    </div>
                    <div class="form-group">
