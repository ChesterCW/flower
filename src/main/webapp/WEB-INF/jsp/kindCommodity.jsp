...
<script>
    ...
    function loadCommodity(page,row) {
        ...
        // 迭代商品
        $.ajax({
            url: "${pageContext.request.contextPath}/commodityByKindId/"+id,
            dataType: 'json',
            data:{"page":page,"row":row,"kindId":id},
            async: false,
            success: function (data) {
                ...
                // $("#page").append('<li class="disabled"><a href="#"><span class="glyphicon glyphicon-menu-left"></span> 上一页</a></li>' +
                //     '<li class="active"><a href="javascript:void(0)">1</a></li>' +
                //     '<li><a href="?r=0&amp;pg=2">2</a></li>' +
                //     '<li><a href="?r=0&amp;pg=3">3</a></li>' +
                //     '<li><a href="javascript:void(0)">…</a></li>' +
                //     '<li><a href="?r=0&amp;pg=10&amp;price=">10</a></li>' +
