...
<form action="${pageContext.request.contextPath}/modifyUse" method="post">
    <div class="container" style="width: 35%">
        <h2><strong>修改用途</strong></h2>
        <div class="form-group">
            <input type="hidden" name="id" value="${use.id}" />
            <label>用途名称</label>
            <input type="text" class="form-control" name="title" value="${use.title}" />
        </div>
