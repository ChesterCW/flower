...
<div class="container">
    <div style="background-color: pink;padding-top: 10%;padding-bottom: 15%">
        ...
        <form action="index" method="get" id="registerForm" onsubmit="return login()">
            ...
            <div style="margin:0 auto; width:400px;">
                ...
                <button type="submit" id="btnRegister1" class="btn btn-primary">登录</button>
                <button type="button" href="javascript:void(0)" onclick="return register()" class="btn btn-primary">注册</button>
            </div>
        </form>
    </div>
</div>
