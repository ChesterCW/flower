...
//			config: function(a, b) {
//				var d = 0;
//				return a = a || {}, f.cache = e.config = c.extend(e.config, a), f.path = e.config.path || f.path, "string" == typeof a.extend && (a.extend = [a.extend]), f.use("layer.css" /*tpa=http://www.sucainiu.com/demo/templates/2016/12/576/js/layer/skin/layer.css*/ , a.extend && a.extend.length > 0 ? function g() {
//					var c = a.extend;
...
//			},
//			use: function(a, b, d) {
//				//http://127.0.0.1:8020/Manager/sucainiu/js/layer.css
//				return 
//				var e = c("head")[0],
//					a = a.replace(/\s/g, ""),
//					g = /\.css$/.test(a),
...
//		return e.run(), f
//	}) : function() {
//		e.run(), f.use("layer.css" /*tpa=http://www.sucainiu.com/demo/templates/2016/12/576/js/layer/skin/layer.css*/ )
//	}()
//}(window);