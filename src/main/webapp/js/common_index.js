...
(function () {
    ...
    hm.src = "hm.js-5f4aa36509ee08b412f4647f6d4f1749.js"/*tpa=https://hm.baidu.com/hm.js?5f4aa36509ee08b412f4647f6d4f1749*/;
 ...
 */
    ...
    (function () {
        ...
        div.innerHTML = "  <link/><table></table><a href='https://img02.hua.com/a'>a</a><input type='checkbox'/>";
...
+function ($) {
    ...
    if (!$.fn.tooltip) {
        throw new Error("Popover requires tooltip.js"/*tpa=https://img02.hua.com/pc/assets/js/Popover requires tooltip.js*/)
    }
...
+function ($) {
    ...
    Tab.prototype.show = function () {
        ...
        var hideEvent = $.Event("https://img02.hua.com/pc/assets/js/hide.bs.tab", {relatedTarget: $this[0]});
        var showEvent = $.Event("https://img02.hua.com/pc/assets/js/show.bs.tab", {relatedTarget: $previous[0]});
        ...
        this.activate($target, $target.parent(), function () {
            $previous.trigger({type: "https://img02.hua.com/pc/assets/js/hidden.bs.tab", relatedTarget: $this[0]});
            $this.trigger({type: "https://img02.hua.com/pc/assets/js/shown.bs.tab", relatedTarget: $previous[0]})
        })
    };
    ...
    function Plugin(option) {
        return this.each(function () {
            var $this = $(this);
            var data = $this.data("https://img02.hua.com/pc/assets/js/bs.tab");
            if (!data) {
                $this.data("https://img02.hua.com/pc/assets/js/bs.tab", (data = new Tab(this)))
            }
            if (typeof option == "string") {
                data[option]()
            }
...
})(window, document, 'script', 'AG_324341_APMX', '1');